...
def write_faraday_figures(output_dir: Path, config: dict[str, Any], stage: dict[str, Any]) -> dict[str, Path]:
    ...
    _write_map_and_line_figure(
        ...
        map_title="Faraday dark-field image",
        line_title="Central lineouts",
        suptitle="Faraday dark-field image",
        vmin=-0.005,
        vmax=0.03,
    )
    _write_map_and_line_figure(
        ...
        ylabel="$S$",
        map_title="Faraday dual-port signal",
        line_title="Central lineouts",
        suptitle="Faraday dual-port signal",
        vmin=-0.45,
        vmax=0.45,
    )
